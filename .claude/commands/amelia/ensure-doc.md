...
ensure all functions and classes follow google documentation standards for both python and typescript

ultrathink and use parallel Agents to explore the codebase and verify, update or add comments where required