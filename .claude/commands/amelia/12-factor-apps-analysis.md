...
1. **Use the skill** - Read `.claude/skills/12-factor-apps/SKILL.md` for search patterns
...
/amelia:12-factor-apps-analysis

# Analyze specific path
/amelia:12-factor-apps-analysis /path/to/project
```
