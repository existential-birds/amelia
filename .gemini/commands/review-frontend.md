...
### 🎨 Sub-Phase B: UI & Shadcn Consistency
...
### ♿️ Sub-Phase C: Accessibility (A11y)
...
| Severity | Definition |
| :--- | :--- |
| **🚨 CRITICAL** | Breaks standard browser behavior (Link vs navigate), Security risk (XSS), Infinite loops. |
| **⚠️ MAJOR** | Reimplementing existing UI components, A11y violations (unreachable via keyboard), ignoring `loader` pattern. |
| **ℹ️ MINOR** | Hardcoded values, missing `cn()` usage, style nitpicks. |
